...
from numpy import zeros, zeros_like, allclose, cos, sin, pi
...
#         self.angle_gradient_func = angle_energy.create_gradient_func()
...
# 
#     def test_computes_correct_gradient(self):
#         E = self.angle_gradient_func(self.X, None)
